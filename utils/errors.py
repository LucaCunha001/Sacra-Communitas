...
class ErrorManager:
    ...
    async def handle_error(
        ...
        *,
        ...
        logger.exception("Erro capturado ao executar o comando %s", command_name)

        try:
            await send_user_feedback(self._build_user_message(command_name, error))
        except Exception:
            logger.error("Falha ao enviar feedback ao usuário", exc_info=True)
        ...
        try:
            ...
            logger.error("Falha ao enviar log para console", exc_info=True)
